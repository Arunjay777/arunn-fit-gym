...
const coreExercises: Exercise[] = [
  { 
    ...
    tip: 'Avoid swinging your hips. Use your lower abs to pull your knees deliberately up toward your chest.',
  ...
  { 
    ...
    weight: 'Bodyweight', 
    rest: 60, 
    target: 'Total Core Stability', 
    tip: 'Tilt your pelvis back slightly. Roll out slowly, brace hard, and pull back using your abdominal wall.',
  ...
  { 
    ...
    tip: 'Keep your hips stationary. Flex at your spine to bring your elbows down to touch your thighs.',
  ...
  { 
    ...
    tip: 'Elevate your feet slightly. Rotate your entire ribcage, tapping the medicine ball floor side-to-side.',
  ...
  { 
    ...
    weight: 'Bodyweight', 
    rest: 45, 
    target: 'Deep Transverse Abdominis', 
    tip: 'Drive your forearms into the floor, engage your glutes, and maintain an absolutely flat pencil line.',
    image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600&auto=format&fit=crop&q=80'
  }
];
...
export default function CoreWorkout() {
  ...
  const handleStartWorkout = () => {
    ...
    coreExercises.forEach((ex, idx) => {
      initialLogs[idx] = {
        notes: '',
        sets: Array.from({ length: ex.sets }).map(() => ({
          weight: ex.weight === 'Bodyweight' ? '0' : ex.weight.replace(' lbs', ''),
  ...
  const handleToggleSetCompletion = (setIdx: number) => {
    ...
    if (isNowCompleted) {
      const restSec = coreExercises[currentExerciseIdx].rest;
  ...
  const handleAddSet = () => {
    ...
    const newLogs = { ...exerciseLogs };
    const setList = [...newLogs[currentExerciseIdx].sets];
    const last = setList[setList.length - 1] || { weight: '0', reps: '12' };
    setList.push({
      weight: last.weight,
      reps: last.reps,
      completed: false,
  ...
  const handleCompleteWorkout = () => {
    ...
    try {
      ...
      Object.entries(exerciseLogs).forEach(([exIdx, log]) => {
        const ex = coreExercises[parseInt(exIdx)];
      ...
      const newSession = {
        ...
        volume: totalWeightLifted || 3500,
        exercises: loggedExercises.length > 0 ? loggedExercises : [
          { name: 'Hanging Knee Raises', sets: 3, reps: [15, 12, 12], weight: 0 },
          { name: 'Ab Wheel Rollouts', sets: 3, reps: [10, 10, 8], weight: 0 }
        ],
        color: '#10B981'
      };
  ...
  const totalPlannedSets = coreExercises.reduce((sum, ex) => sum + ex.sets, 0);
    ...
    <div className="min-h-screen p-4 lg:p-8 select-none relative pb-20">
      ...
      {showCompletionOverlay && (
        <div className="fixed inset-0 bg-[#030303]/95 backdrop-blur-xl z-50 flex items-center justify-center p-4">
          <TacticalCard glow className="max-w-md w-full p-8 border border-emerald-500/30 text-center relative overflow-hidden">
            ...
            <h2 className="font-mono text-xl font-bold text-white mb-2 tracking-tight">CORE PROTOCOL COMPLETE!</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center">
                ...
                <div className="font-mono text-lg font-bold text-emerald-400">{(currentLiftedVolume || 0).toLocaleString()} lbs</div>
              </div>
              <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center col-span-2">
                ...
                <div className="font-mono text-sm font-bold text-white">
                  {currentTotalCompletedSets} sets / {coreExercises.length} Exercises Complete
                </div>
              </div>
            </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
          ...
          <TacticalHeader title="CORE WORKOUT" subtitle="SIMPLE EFFICIENCY • ABS, OBLIQUES & POSTURAL STABILITY" />
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <TacticalCard glow className="relative overflow-hidden p-6 lg:p-8">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-mono text-lg font-bold text-white">CORE TRAINING ROUTINE</h3>
                  <p className="font-mono text-xs text-cyan-400/60 uppercase tracking-widest">Target: Rectus abdominis & obliques</p>
                </div>
              </div>
              
              <p className="font-mono text-sm text-white/70 mb-6 leading-relaxed">
                Build a rock-solid, functional core. This targeted session strengthens deep stabilizing abdominal structures, helping protect your spine and enhance your lifting compound movement ceilings.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center sm:text-left">
                  ...
                  <div className="font-mono text-sm font-bold text-cyan-400 mt-1">30 MIN</div>
                </div>
                <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center sm:text-left">
                ...
                <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center sm:text-left">
                  ...
                  <div className="font-mono text-sm font-bold text-cyan-400 mt-1">MIDSECTION COMPRESSION</div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <TacticalCard>
              ...
              <ul className="space-y-3">
                {[
                  { title: "Posterior Pelvic Tilt", desc: "Prioritize tilting your pelvis upwards on crunches to actively align and contract the abdominal wall." },
                  { title: "Lower Back Protection", desc: "Never arc or sag your lower back downward during wheel rollouts or planks." },
                  { title: "Controlled Breathing", desc: "Exhale deeply at maximum contraction fold to trigger deep transverse ab activation." }
                ].map((item, idx) => (
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <TacticalCard className="p-6 relative overflow-hidden">
              ...
              <div className="h-64 sm:h-80 w-full rounded-2xl overflow-hidden relative mb-6 border border-white/10">
                <img
                  src={coreExercises[currentExerciseIdx].image}
                  alt={coreExercises[currentExerciseIdx].name}
                  referrerPolicy="no-referrer"
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <h3 className="font-mono text-xl sm:text-2xl font-bold text-white uppercase">{coreExercises[currentExerciseIdx].name}</h3>
                  <p className="font-mono text-xs text-white/60 uppercase">{coreExercises[currentExerciseIdx].target}</p>
                </div>
              </div>
              ...
              <div className="p-3.5 bg-white/5 rounded-xl border border-white/5 flex gap-3 text-white/70 mb-5 text-sm font-mono leading-relaxed">
                ...
                <div>
                  ...
                  {coreExercises[currentExerciseIdx].tip}
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-12 gap-2 text-center text-white/40 font-mono text-[10px] uppercase tracking-wider mb-1">
                  ...
                  <div className="col-span-4">LBS (OR EXTRA)</div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-between pt-4">
              <div className="flex gap-2 w-full sm:w-auto">
                ...
                {currentExerciseIdx < coreExercises.length - 1 ? (
                  <button
                    onClick={() => {
                      playBeep(450, 0.05);
                      setCurrentExerciseIdx(prev => prev + 1);
